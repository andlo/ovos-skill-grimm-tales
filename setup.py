...
URL = "https://github.com/andlo/ovos-skill-grimm-tales"
SKILL_CLAZZ = "GrimmTales"  # needs to match __init__.py class name
PYPI_NAME = "ovos-skill-grimm-tales"  # pip install PYPI_NAME
...
setup(
    name=PYPI_NAME,
    version=get_version(),
    description="Brothers Grimm fairy tales provider skill for ovos-common-reading-pipeline-plugin",
    ...
    keywords="ovos skill voice assistant fairytales grimm storytelling",
